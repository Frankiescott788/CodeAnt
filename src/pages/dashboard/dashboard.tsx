...
export default function Dashboard() {
    ...
    return (
        <div className="bg-[#FAFAFA] h-screen">
            ...
            { <div className={` ${onOpen ? "block" : "hidden"} mobile-humb lg:hidden fixed top-0 right-0 left-0 z-40 bottom-0 transition-all`}>
                <div className={"bg-white"}>
                    <div className={"flex justify-between px-2"}>
                        ...
                        <div className={"pt-5 pe-3"} onClick={openHumb}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24}
                                 color={"#000000"} fill={"none"}>
                    ...
                    <div className="flex">
                        <div className="flex justify-between w-full border p-2 mx-3 rounded-lg">
                            <p>UtkarshDhairPa...</p>
                            <div>
                                <ArrowDown2 size="24" color="black"/>
                            </div>
                    ...
                    <ul className="px-3 flex flex-col gap-2 py-4">
                        <li className="flex gap-3 bg-[#1570EF] p-2 rounded-md">
                            <div>
                                <Home2 size="24" color="white"/>
                            </div>
            ...
            <nav className={` ${onOpen ? "block" : "hidden"}bg-white lg:hidden block`}>
                <div className={"flex justify-between px-2 bg-white"}>
                    <div className="flex gap-1 mx-3 py-3">
                        <Image src={Logo} className="w-[2rem] object-cover"/>
                        <p className="text-2xl mt-1 ">CodeAnt AI</p>
                    </div>
                    <div className={"pt-3"} onClick={openHumb}>
